...
class EditRecipe extends React.Component {
  ...
  submit(data) {
    const { name, imageURL, prepTime, servingSize, ingredients, description, _id } = data;
    Recipes.collection.update(_id, { $set: { name, imageURL, prepTime, servingSize, ingredients, description } }, (error) => (error ?
